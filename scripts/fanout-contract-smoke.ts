...
assert.deepEqual(counts, { total: 3, completed: 1, failed: 1, skipped: 0, cancelled: 1, timed_out: 0 })
...
assert.equal(descriptors[0].artifactNamespace, "design")
assert.equal(descriptors[1].agent, "default-agent")
