...
try {
  ...
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.schema, "wp-codebox/worker-fanout-evidence/v1")
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.timing.startup.available, true)
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.timing.duration.available, true)
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.timing.cleanup.state, "completed")
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.resources.hostProcess.available, true)
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.resources.runtimeMemory.available, false)
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.resources.runtimeProcessCount.available, false)
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.artifacts.available, true)
  assert.equal(typeof passingRunRegistryEntry.metadata.workerFanoutEvidence.artifacts.bytes, "number")
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.reliability.failureClassification.value, "none")
  assert.equal(passingRunRegistryEntry.metadata.workerFanoutEvidence.reliability.retryCount.available, false)
  ...
  assert.equal(failingRunRegistryEntry.metadata.workerFanoutEvidence.artifacts.available, true)
  assert.equal(failingRunRegistryEntry.metadata.workerFanoutEvidence.reliability.failureClassification.value, "execution")
  assert.equal(failingRunRegistryEntry.metadata.workerFanoutEvidence.reliability.retryCount.available, false)
