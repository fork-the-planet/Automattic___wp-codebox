...
$assert( 'browser Playground agents/chat runner forwards sandbox tool policy', str_contains( $runner_php, "'tool_policy'" ) && str_contains( $runner_php, "'allow_only'" ) && str_contains( $runner_php, "'completion_assertions'" ) && str_contains( $runner_php, "'required_tool_names'" ) );
...
$assert( 'generated browser runner source contains no Data Machine identifiers', ! is_wp_error( $browser_inherited_session ) && ! str_contains( $browser_runner_code, 'datamachine_' ) && ! str_contains( $browser_runner_code, 'DataMachine' ) );
