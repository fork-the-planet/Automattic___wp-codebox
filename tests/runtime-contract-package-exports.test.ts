...
assert.equal(contracts.SANDBOX_ISOLATION_PROOF_SCHEMA, "wp-codebox/sandbox-isolation-proof/v1")
...
assert.equal(contracts.SANDBOX_ISOLATION_PROOF_ARTIFACT_KIND, "sandbox-isolation-proof")
...
assert.equal(typeof contracts.sandboxIsolationProof, "function")
