...
assert.doesNotMatch(runtimePackageServicePhp, /function legacy_task_input\( array \$input \)/)
...
assert.match(runtimePackageExecutorPhp, /'agents\/chat'/)
assert.match(runtimePackageExecutorPhp, /\.agent\.json/)
assert.doesNotMatch(runtimePackageExecutorPhp, /manifest\.json|flows\//)
...
assert.match(fuzzSuiteRunnerPhp, /wordpress\.simulated-admin-page-load/)
assert.match(fuzzSuiteRunnerPhp, /wordpress\.simulated-frontend-page-load/)
