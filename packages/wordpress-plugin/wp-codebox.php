...
define( 'WP_CODEBOX_PLUGIN_VERSION', '0.12.18' );
...
require_once __DIR__ . '/src/class-wp-codebox-browser-task-contract-service.php';
...
require_once __DIR__ . '/src/class-wp-codebox-runner-workspace-tools.php';
require_once __DIR__ . '/src/trait-wp-codebox-runner-workspace-executor-behavior.php';
require_once __DIR__ . '/src/class-wp-codebox-runner-workspace-executor.php';
