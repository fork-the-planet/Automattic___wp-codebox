...
export const commandRegistry = [
  ...
  },
  {
    ...
    outputShape: "wp-codebox/visual-compare/v1 JSON summary plus files/browser/visual-compare/source.png, candidate.png, diff.png, visual-diff.json, and visual-explanation.json when DOM/style context is available.",
