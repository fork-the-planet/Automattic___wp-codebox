...
export const commandRegistry = [
  ...
  },
  {
    ...
    outputShape: "Benchmark results JSON envelope with component_id, iterations, scenarios, aggregated metrics, and optional per-scenario steps/artifacts/metadata/diagnostics.",
