...
export const commandRegistry = [
  ...
  },
  {
    ...
    acceptedArgs: [
      ...
      { name: "baseline-visual-diff", description: "Alias for baseline when pointing at a previous visual-diff.json artifact.", format: "path" },
      { name: "baseline-artifact", description: "Alias for baseline when pointing at an aggregate visual comparison artifact.", format: "path" },
