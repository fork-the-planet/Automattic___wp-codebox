...
export const commandRegistry = [
  ...
  },
  {
    ...
    outputShape: "JSON object with command=wordpress.server-page-load, resolvedUrl, status, headers, bodyBytes, and a performance observation marked source=server-http kind=server-page-load.",
  ...
  },
  {
    ...
    outputShape: "wp-codebox/wordpress-page-load-result/v1 JSON with performance source=in-process kind=simulated-page-load.",
    outputSchema: { id: WORDPRESS_PAGE_LOAD_RESULT_SCHEMA, jsonSchema: WORDPRESS_PAGE_LOAD_RESULT_JSON_SCHEMA },
  ...
  },
  {
    ...
    outputShape: "wordpress.browser-probe JSON summary and browser artifacts, with command=wordpress.browser-page-load.",
