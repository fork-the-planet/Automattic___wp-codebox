...
export const commandRegistry = [
  ...
  },
  {
    ...
    outputShape: "JSON object { total_blocks, valid_blocks, invalid_blocks, validation_method: 'wp.blocks.validateBlock', validation_provider, results: [{ name, isValid, issues }] } plus files/browser/editor-validate-blocks.json and editor-validate-blocks-summary.json evidence artifacts.",
    outputSchema: {
